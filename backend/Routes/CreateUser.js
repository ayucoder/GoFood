...
router.post('/createuser', [
    ...
    console.log('/createuser Response', req.body)
    let success = false
...
router.post('/getlocation', async (req, res) => {
    try {
        ...
        let response = await fetch("https://api.opencagedata.com/geocode/v1/json?q=" + lat + "+" + long + "&key=74c89b3be64946ac96d777d08b878d43", {
            method: "Get"
        })
            // .then(async res => {
        ...
        console.log('/getlocation', location?.results[0].formatted)
        res.send({ location: location?.results[0].formatted})
